...
#define COMSIG_LIVING_TOD_CHANGE_DAWN "living_tod_change"		//from /mob/living/proc/do_time_change()
#define COMSIG_LIVING_SURRENDER "living_surrender"				//from /mob/living/proc/submit()
