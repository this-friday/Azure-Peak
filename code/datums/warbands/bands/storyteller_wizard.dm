/datum/warbands/wizard
	...
	aspects = list(ASPECT_SURPRISE, ASPECT_HOST, ASPECT_ENVY, ASPECT_FIGUREHEAD, ASPECT_SCUM, ASPECT_WAR, ASPECT_BATTLETESTED, ASPECT_BADSPAWN, ASPECT_RANDOM, ASPECT_SPLINTERED, ASPECT_MARKED, ASPECT_SUPPLIES)
	spawns = RESPAWNS_LOW
	...
	lieutenantclasses = list(/datum/advclass/warband/wizard/lieutenant/magus)
